<x-dashboard-layout>
    <x-slot name="pageTitle">Create Call Center</x-slot>

    <x-slot name="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
        <li class="breadcrumb-item"><a href="{{ route('agent.index') }}">Call Centers</a></li>
        <li class="breadcrumb-item active">Create Call Center</li>
    </x-slot>

    <div>
        <form class="card" action="{{ route('call-center.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="card-header"><strong>Create Call Center</strong></div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control @error('center_name') is-invalid @enderror" id="center_name" name="center_name" type="text" placeholder="Enter the call center name" value="{{ old('center_name') }}" required>
                        @error('center_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 form-group text-left">
                        ...
                        <input class="form-control @error('address_line') is-invalid @enderror" id="address_line" name="address_line" type="text" placeholder="Enter center address" value="{{ old('address_line') }}" required>
                        @error('address_line')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control @error('city') is-invalid @enderror" id="city" name="city" type="text" placeholder="Enter city name" value="{{ old('city') }}" required>
                        @error('city')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control @error('state') is-invalid @enderror" id="state" name="state" type="text" placeholder="Enter state" value="{{ old('state') }}" required>
                        @error('state')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control @error('post_code') is-invalid @enderror" id="post_code" name="post_code" type="text" placeholder="Enter post code" value="{{ old('post_code') }}" required>
                        @error('post_code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
